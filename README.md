...
El comando mantiene solo los próximos 3 días del plan, los agenda y los envía al último dispositivo Garmin. Es reanudable: `data/garmin_plan_state.json` evita repetir lo que ya terminó. Las sesiones de fuerza están limitadas a menos de 50 pasos expandidos, que es el límite relevante del reloj.
